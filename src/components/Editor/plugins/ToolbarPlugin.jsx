...
function BlockOptionsDropdownList({ editor, blockType, toolbarRef, setShowBlockOptionsDropDown }) {
      ...
      editor.update(() => {
        ...
        if ($isRangeSelection(selection)) {
          $wrapNodes(selection, () => {
            ...
            $wrapNodes(selection, () => cell);
            $wrapNodes(selection, () => row);
            $wrapNodes(selection, () => table);
  ...
  return (
    <div className="dropdown" ref={dropDownRef}>
      ...
      <button className="item" onClick={formatTable}>
        <span className="icon table" />
        <span className="text">Table</span>
        {blockType === 'table' && <span className="active" />}
      </button>
    </div>
  );
}
